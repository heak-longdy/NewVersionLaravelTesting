...
* @see app/Http/Controllers/FileManagerController.php:30
* @route '/file-manager'
*/
...
* @see app/Http/Controllers/FileManagerController.php:88
...
* @see app/Http/Controllers/FileManagerController.php:106
* @route '/file-manager'
*/
...
* @see app/Http/Controllers/FileManagerController.php:382
...
* @see app/Http/Controllers/FileManagerController.php:246
...
* @see app/Http/Controllers/FileManagerController.php:301
* @route '/file-manager/{fileItem}'
*/
...
* @see app/Http/Controllers/FileManagerController.php:316
...
* @see app/Http/Controllers/FileManagerController.php:333
...
* @see app/Http/Controllers/FileManagerController.php:358
...
const FileManagerController = { index, api, store, download, update, destroy, restore, forceDelete, emptyTrash }
